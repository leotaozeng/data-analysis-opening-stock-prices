...
public class Main {
    public static void main(String[] args) {
        ...
        obj.insertBack(29.3f);
        obj.insertBack(143.2f);

        obj.insertFront(10.2f);
        obj.insertFront(42.82f);

        obj.insertAt(2, 65.78f);
        obj.insertAt(5, 345.67f);

        obj.removeFront();
        obj.removeBack();
        System.out.println(obj.stockPricesList);
    }
}